...
Vue Router 4 是 Vue 3 的官方路由库，支持组合式 API、动态路由、路由守卫、懒加载等特性。Vue3 项目级训练工程使用 Vue Router 4 实现页面导航和权限控制。
...
在 Vue3 项目级训练工程中，Vue Router 4 用于：
...
- 示例来源：通用训练工程抽象
- 示例来源：通用训练工程抽象（路由配置）
- 示例来源：通用训练工程抽象（useRouter/useRoute 使用）
- 示例来源：通用训练工程抽象（路由器注册）
